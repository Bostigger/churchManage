...
<?php
     ...
     <td><?php echo $row['Baptismal_stat']; ?></td>
     <td>  <a href="view.php?view=<?= $row['id']; ?>"
                          class="badge badge-warning p-2">View Details</a> | <a href="update.php?edit=<?= $row['keyu']; ?>"
                                        class="badge badge-info p-2" style="float: right;">Edit Record</a>  </td>
