   ...
   <script type="text/javascript">
	...
	$('#add').tooltip('hide');
					...
					<div class="control-group">
                                ...
                                <p> <div class="controls">
                                   <p>
                                     <input class="input focused" name="lname" id="focusedInput" value="<?php echo $row['oname']; ?>" type="text" placeholder = "Last name" required>
                                   </p>
                                 </div>
                                  </div>
								  <div class="control-group">
                                ...
                                <p> <div class="controls">
                                   <p>
                                     <input class="input focused" name="residence" id="focusedInput" value="<?php echo $row['Region']; ?>" type="text" placeholder = "Residence" required>
                                   </p>
                                 </div>
                                  </div>
								  </p>
                                ...
                                <p> <div class="controls">
                                   <p>
                                     <input class="input focused" name="pob" id="focusedInput" value="<?php echo $row['town']; ?>" type="text" placeholder = "place of birth" required>
                                   </p>
                                 </div>
                                  </div>
								  </p>		
